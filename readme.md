...
Diana and Manx provide all the other specialists largely divided by region to minimise overlap and make it easier to get a specific specialist.
...
Some other smaller categories include aqueduct buffs, workforce buffs, workforce swaps for certain buildings and some public service building buffs.
...
There is no overlap between traders except that Diana and Manx share most of their legendaries, except the small few that boost only their respective regions workforce. These are split accordingly.

## Valeria
Valeria now has all civilian ship captains with buffs like ship speed, cargo transfer speed, region transfer speed etc.
...
## Diana
Diana has all Latium goods based buffs along with the basic residence buffs for money/knowledge/prestige/happiness.

## Manx
Manx has all Albion goods based buffs along with the basic residence buffs for belief/fire safety/health.
...
If someone else wants to use this mod as a framework for doing the same thing with their own idea of balance you are more than welcome. I have left my internal lists that I used inside the mod files both for myself and anyone else who can benefit from them.
